...
abstract class UserRemoveDialog extends AbstractFormDialog<AddressBookUser> {
	...
	public UserRemoveDialog(String id, String title) {
		super(id, title, true);
		...
		// Slider //
		this.form.add(new Label("username"));
		this.form.add(new Label("password"));
		this.form.add(new Label("role"));
